...
#     dummy_dim_creation_task = EmptyOperator(task_id="finalize_dim_creation")
...
#     start_task >> dim_creation_tasks >> dummy_dim_creation_task
#     dummy_dim_creation_task >> fact_creation_tasks >> end_task