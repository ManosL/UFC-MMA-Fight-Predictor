...
def evaluateBestClassifiers(clf_refs, clf_params, X, y, X_val, y_val, k=10, repeats=2,
    ...
    fig.write_html("/workspace/results/Best_clfs.html")
    ...
    fig.write_html("/workspace/results/best_heatmaps.html")
    ...
    fig.write_html("/workspace/results/best_clfs_times.html")
...
def _plot_results(clf_name, og_dataset_results, double_dataset_results,
    ...
    fig.write_html(f"/workspace/results/metrics_{clf_name}.html")
